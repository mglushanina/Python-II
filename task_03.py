...
class range__iter_generator:
    """Напишите range, через класс и используя генераторную функцию
    для __iter__
...
QUESTIONS.append(
    """
    Какие вещи потребовалось сделать, чтобы передать состояние итерации
    в генератор?
    """
)
...
"""
Напишите range так, чтобы дополнительно к стандартному синтаксису,
работала конструкция

range[:10], другими словами работал метод __getitem__ со slice в
качестве аргумента
"""
